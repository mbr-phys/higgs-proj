...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=0.45\textwidth]{mB-rH0.png}
        \includegraphics[width=0.45\textwidth]{mB-rH1.png}
        \caption{$m_{B^+} \implies V_{ub}$}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=0.45\textwidth]{mD-rH0.png}
        \includegraphics[width=0.45\textwidth]{mD-rH1.png}
...
\begin{figure}[H]\ContinuedFloat
    \centering
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=0.45\textwidth]{mDs-rH0.png}
        \includegraphics[width=0.45\textwidth]{mDs-rH1.png}
        \caption{$m_{D_s} \implies V_{cs}$}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=0.45\textwidth]{mK-rH0.png}
        \includegraphics[width=0.45\textwidth]{mK-rH1.png}
        \caption{$m_{K^+} \implies V_{us}$}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=0.45\textwidth]{mpi-rH0.png}
        \includegraphics[width=0.45\textwidth]{mpi-rH1.png}
