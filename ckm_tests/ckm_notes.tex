...
\begin{itemize}
    ...
    \item There's no likelihood tests on this at all, it is just a scan for now
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.49\textwidth]{heatmaps/ckm_mod_errs.png}
    \caption{The black region represents areas where the first two rows of the CKM matrix break unitarity from 2HDM modification as discussed above; the white is where unitarity is still possible within standard errors.}
\end{figure}
