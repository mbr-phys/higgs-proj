...
\begin{itemize}
    ...
    \item For the right, we have $m_{H^+}\gtrsim980\,$GeV, $\tan\beta\lesssim6.8$; in my project for this, I had $m_{H^+}\gtrsim500\,$GeV and $\tan\beta\lesssim21$
\end{itemize}
